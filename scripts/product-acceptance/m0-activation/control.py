...
# The daemon's canonical unit allows 260 seconds for its bounded durable drain.
# Rollback must outlive that contract instead of reporting failure while systemd
# is still completing a valid stop.
ROLLBACK_COMMAND_TIMEOUT_SECONDS = 270.0
...
RESTART_COMMAND_TIMEOUT_SECONDS = 270.0
...
MAX_JOURNEY_COMMAND_TIMEOUT_SECONDS = 1_200.0
