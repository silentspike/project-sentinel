...
pub const DEFAULT_COMPANY_CONTEXT_PATH: &str = "/opt/sentinel/config/company-context.md";
...
pub const DEFAULT_BUDGET_WINDOW_USD: f64 = 0.10;
...
pub const SESSION_ACTIVE_LOCK_FILE_NAME: &str = ".active.lock";
