...
| **System/Artifact** | Deploy binary to VM, `curl -sf http://localhost:8080/health` | VM 192.0.2.240 | Health response + journalctl |
| **E2E/Smoke** | `cd tests/e2e && bun test` (playwright-cli based) | VM 192.0.2.240 + browser | Screenshots + test report |
