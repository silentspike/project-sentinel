...
// POST /chat wurde entfernt — Operator-Chat laeuft jetzt ueber
// /api/operator/chat (Reverse-Proxy in control.ts → Daemon Operator-API).
// Der alte System-Prompt-Code ("Du bist ein Mitarbeiter...") umging den
// Cortex Gateway Assembler (kein Company Context, kein DNA, kein Evolution).
