...
**Binary:** `cargo bench -p sentinel-hippocampus` (Release, Criterion), ausgefuehrt auf VM 10.0.0.240.
...
- 2026-02-15: Runtime Orchestrator Benchmark (Issue #15): Spawn 1.51ms, Restore 22us, Pause+Resume 234us, Footprint 96 bytes/Orchestrator + 72 bytes/Agent auf VM 10.0.0.240.
