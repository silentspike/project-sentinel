...
| [ADR-0495-G3-provisionnode-threat-model](ADR-0495-G3-provisionnode-threat-model.md) | G3 | Allowlist targets, out-of-band host-key pin, target-local keys, reciprocal cert/NodeId pins, repo-templated token-gates | Proposed |
