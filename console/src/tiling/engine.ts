...
export type PanelKind = "agents" | "floorplan" | "metrics" | "profiling" | "cockpit" | "activity" | "chaos" | "chat" | "control" | "timetravel" | "gaia-wizard" | "agent-editor" | "config-editor" | "synthesis" | "cost" | "org-chart";
