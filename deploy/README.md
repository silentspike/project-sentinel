...
- Host: `ubuntu@10.0.0.240` (Proxmox VM 1069)
...
ssh ubuntu@10.0.0.240 'bash -s' < deploy/bench/run-stack-suite-guest.sh

# P0-Gate-Tests (Zenoh SHM, Persist, Circuit Breaker)
ssh ubuntu@10.0.0.240 'bash -s' < deploy/bench/run-p0-gates-guest.sh
```
