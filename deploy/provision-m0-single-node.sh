...
def artifact_authority() -> dict[str, tuple[str, str]]:
    rows = {
        ...
        "/opt/sentinel/config/company-principals.json": ("config/company-principals.json", "config"),
        "/opt/sentinel/config/workbench-profiles/web-qa-v1.toml": ("config/workbench-profiles/web-qa-v1.toml", "config"),
